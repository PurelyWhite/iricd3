  ...
  for (var i = 0; i < files.length; i++) {
    ...
    reader.onload = function(d) {
      ...
      d3.csv(contents, function (data) {
        ...
        return (extremeXAll.push(xRange[0]), extremeXAll.push(xRange[1]), extremeYAll.push(yRange[0]), extremeYAll.push(yRange[1]));
      })
    }
  var extremeX = d3.extent(extremeXAll);
  var extremeY = d3.extent(extremeYAll);
  console.log(extremeX);
  }
}
